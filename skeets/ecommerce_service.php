	...
	<div id="wrapper">
		...
		<header id="rst-header" class="wpb_row">
			...
			<div class="rst-header-banner rst-banner-background rst-banner-3 rst-index-page-banner">
                          ...
                          <div class="container-fluid" style="padding:10px 40px"> 
                             ...
                             <div class="col-md-5 text-left">
                               <div class="overlay-content1">
                                 <h6 class="text-center" style="color:#fff;">SERVICES</h6> <br> 
                                     <div class="col-md-6 text-left">
                                        ...
                                        <img src="images/images/line.png" style="padding-left:10px;box-sizing:border-box">
                                         ...
                                         <a href="http://localhost/skeets/graphic_service.php">Web Designing</a>
                             ...
                             <div class="col-md-3 text-left">
                               <div class="overlay-content1">
                                 <h6 style="color:#fff">PORTFOLIO</h6> <br> 
				...
				<!-- Banner content -->
				<div class="rst-banner-content"  style="background-image:url(images/ecommercebanner.png);background-position:center;background-size:cover; max-width:100%;background-repeat:no-repeat">
					<div class="container">
						<div class="row">
						  <div class="col-sm-6">
			...
			<div id="rst-home-whoweare" class="wpb_row" style="padding:0px 0 110px;">
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-6 wow animated zoomIn"  style="padding-top:156px">
							<img src="images/compress image/ecommerce-dev-min.png" alt=""  />
						</div>
					</div>
				</div>
				<!--<div class="rst-scroll-down text-center">
